...
int main() {
    ...
    try {
        ...
        config.memory_management.memory_pressure_threshold_mb = 100; // 100MB threshold
        ...
        std::cout << "✅ Should throttle ingestion: " << (throttle ? "true" : "false") << "\n";
        ...
        LogEntry log;
        log.raw_log_line = "192.168.1.1 - - [21/Jan/2022:12:00:00 +0000] \"GET /test HTTP/1.1\" 200 1024 \"-\" \"test-agent\"";
        ...
        std::cout << "Milestone 5.2 - AnalysisEngine Memory Management Integration COMPLETED ✅\n";
