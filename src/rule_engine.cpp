...
void RuleEngine::check_historical_comparison_rules(
    const AnalyzedEvent &event_ref) {
  const auto event = std::make_shared<const AnalyzedEvent>(event_ref);
...
// TODO: Placeholder for asset scraping (will be refactored)
...
// TODO: Placeholder for header anomalies (will be refactored)
